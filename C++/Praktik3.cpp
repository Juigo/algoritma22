...
int main ()
{
    ...
    break;
    case 5: int angka_pertama, angka_kedua;
            cout << "Masukkan angka pertama: "; cin >> angka_pertama;
            cout << "Masukkan angka kedua: "; cin >> angka_kedua;
            int hasil_modulus = angka_pertama % angka_kedua;
            cout << "Hasil Modulus: " << hasil_modulus << endl;
    break;
    }
    return 0;
}